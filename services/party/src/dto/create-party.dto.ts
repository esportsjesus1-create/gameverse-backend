...
export class CreatePartyDto {
  @ApiProperty({ description: 'Party name', maxLength: 100 })
  @IsString()
  @MaxLength(100)
  name: string;
  ...
  @ApiPropertyOptional({ enum: PartyVisibility, default: PartyVisibility.FRIENDS_ONLY })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Generate join code' })
  @IsOptional()
  @IsBoolean()
